...
const Alogin = () => {
  ...
  return (
    ...
    <h2 style={{ position: "relative", bottom: "300px", right: "300px", transform: "scaleX(-1.5)",}} > <Link to="/" className='text-gray-500 hover:text-gray-900'><FaSignOutAlt/></Link></h2>
      ...
      <div className="relative  bg-green-300 p-8 rounded-md shadow-md overflow-hidden" style={{display:"flex",height:"420px",width:"620px"}}>
      <div>
        <img src='https://imageio.forbes.com/specials-images/imageserve/647facd9f5654bc6b057b386/Couple-relax-on-the-beach-enjoy-beautiful-sea-on-the-tropical-island/960x0.jpg?format=jpg&width=960'  style={{marginRight:"35px",height:"360px",width:"270px"}} />
      </div>
