...
const Anavbar = () => {
  ...
  return (
    <Navbar bg="" variant="dark" expand="lg" style={{backgroundColor:"teal"}}>
      <Container>
        <Navbar.Brand><Link to='/ahome' style={{color:"white",textDecoration:"none"}}>Trip_Planner</Link></Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto" >
            ...
            <Link to="/hotels" style={{padding:"10px",color:"white",textDecoration:"none"}}>Hotels</Link>
            <Link to="/restaurants" style={{padding:"10px",color:"white",textDecoration:"none"}}>Restaurants</Link>
            <Link to="/places" style={{padding:"10px",color:"white",textDecoration:"none"}}>Places</Link>
