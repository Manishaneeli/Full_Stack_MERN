  ...
  return (
    <div>
      ...
      <div className="mt-8 p-4 border rounded shadow-lg bg-gray-300 p-4 rounded-lg shadow-md" style={{width:"45%"}}>
        <h2 className="text-2xl font-semibold mb-4 text-center">Add Hotel</h2>
        <form onSubmit={handleSubmit}>
         

          <div className="mb-4" style={{display:"flex",justifyContent:"space-around"}}>
         <div>
         <label className="block text-black-900 text-center" >Hotel Name</label>
          <input
            type="text"
            name="name"
        ...
        <div>
        <label className="block text-black-900 text-center" >Hotel Type</label>
           <input
            type="text"
            name="type"
            placeholder='type'
     ...
     <p style={{display:"flex",justifyContent:"center"}}>Prices</p>
        <div className="mb-4" style={{display:"flex",justifyContent:"space-around"}}>
          ...
          <div>
            <label className="block text-black-900 text-center">Normal_Suite</label>
          <input
            type="text"
            name="normal_suite"
            placeholder='normal_Price'
            value={formData.prices.normal_suite}
          ...
          />
           ...
           <div >
          <label className="block text-black-900 text-center">Vip_Suite</label>
          <input
            type="text"
            name="vip_suite"
            placeholder='Vip_Price'
            value={formData.prices.vip_suite}
            onChange={handlePriceChange}
            className="border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            required
            style={{width:"280px"}}
